<div class="col-md-4">
    <div class="card mb-4 shadow-sm">
        <img src="https://via.placeholder.com/640x480.png/00eeaa?text=cars+sit" height="300" class="card-img-top" style="max-width: 100%; margin: 0 auto; display: block;">
{{--        <img src="{{ $product->thumbnail }}" height="300" class="card-img-top" style="max-width: 100%; margin: 0 auto; display: block;">--}}
        <div class="card-body">
